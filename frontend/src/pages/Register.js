...
const Register = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-indigo-50 via-white to-primary-50 flex items-center justify-center px-4">
        ...
        <div className="glass-card shadow-2xl border border-white/30 overflow-hidden">
          ...
          <form onSubmit={onSubmit}>
            ...
            <div className="form-group">
              ...
              <select name="role" onChange={onChange} value={formData.role} className="input-field">
                <option value="buyer">Buyer</option>
                <option value="farmer">Farmer</option>
              </select>
            </div>

            <p className="text-xs text-slate-600 mb-6 p-3 bg-slate-50 rounded-lg">
              <span className="font-semibold text-slate-700 block mb-1">By signing up, you agree to:</span>
