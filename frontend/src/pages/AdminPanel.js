      ...
      <div className="mb-8">
        <div className="flex flex-wrap gap-1 border-b border-slate-200 dark:border-slate-700">
          <button
            ...
            className={`py-3 px-6 font-semibold transition-all duration-200 border-b-2 ${activeTab === 'dashboard'
          ...
          <button
            ...
            className={`py-3 px-6 font-semibold transition-all duration-200 border-b-2 ${activeTab === 'users'
                ? 'border-primary-600 text-primary-600 bg-primary-50 dark:bg-primary-900/20'
                : 'border-transparent text-slate-600 dark:text-slate-400 hover:text-slate-900 dark:hover:text-slate-100'
              }`}
          >
          ...
          <button
            ...
            className={`py-3 px-6 font-semibold transition-all duration-200 border-b-2 ${activeTab === 'crops'
                ? 'border-primary-600 text-primary-600 bg-primary-50 dark:bg-primary-900/20'
                : 'border-transparent text-slate-600 dark:text-slate-400 hover:text-slate-900 dark:hover:text-slate-100'
              }`}
          >
          ...
          <button
            ...
            className={`py-3 px-6 font-semibold transition-all duration-200 border-b-2 ${activeTab === 'settings'
                ? 'border-primary-600 text-primary-600 bg-primary-50 dark:bg-primary-900/20'
                : 'border-transparent text-slate-600 dark:text-slate-400 hover:text-slate-900 dark:hover:text-slate-100'
              }`}
          >
